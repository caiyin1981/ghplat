	...
	<head>
		...
		$(document).ready(function(){
			...
			$(document).delegate('.subButton','click',function(e){
	            ...
	            (
	                {
	                    url: '../saveContent', //用于文件上传的服务器端请求地址
		...
		<fieldset style="margin-top: 20px;width:94%;margin-left:3%;">
			...
			<div style="width:90%;margin:0 auto;overflow: hidden;">
				<div style="margin-top:20px;width:100%;overflow: hidden;">
					...
					<div style="float:left;"><input style="width:200px;" class="ctitle" placeholder="请输入标题" type="text" /></div>
					<div style="float:left;width:50px;line-height: 42px;margin-left:50px;">作者：</div>
					<div style="float:left;"><input style="width:200px;" class="cauthor" placeholder="请输入作者" type="text" /></div>
				...
				<div style="margin-top:20px;width:100%;overflow: hidden;">
					...
					<div style="float:left;"><input id="contentImage" class="cimage" style="width:200px;" placeholder="请上传图片" name="file" type="file" /></div>
					<div style="float:left;width:200px;line-height: 42px;margin-left:20px;">（图片尺寸550*180）</div>
				</div>
				<div style="margin-top:20px;width:100%;overflow: hidden;">
					<div style="float:left;width:120px;line-height: 42px;">添加自媒体关联：</div>
					<div publishId="0" style="float:left;margin-left:10px;margin-right: 20px;line-height: 38px;height:38px;display:none;" class="meitiSelect"></div>
...
<div style="display:none;">
	<div id="addPublishDiv" style="padding:30px 50px;width:400px;background: white;margin:0px;overflow: hidden;">
		...
		{{ } }} 
				...
				<div style="margin-top:20px;width:100%;overflow: hidden;">
					<textarea id="elem1" rows="22" cols="80" style="width: 80%"></textarea>
				</div>
