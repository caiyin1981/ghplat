...
<body style="font-family: 幼圆;padding:0px;margin:0px;">
	...
	<div class="Hui-aside" style="width:260px;height:auto;background:rgb(71,71,71);top:58px;bottom:0px;overflow: hidden;position: absolute;">
		<div class="menu_dropdown bk_2">
			<dl id="menu-article" style="pading:0px;margin:0px;">
				<dt>
					<div class="totalDiv" style="width:100%;height:50px;background: rgb(46,46,46);cursor: pointer;">
						<div class="backDiv" style="float:left;background: rgb(235,100,100);width:5px;height:50px;"></div>
						<div style="float:left;padding-top:13px;margin-left:10px;"><img src="front/images/1.png" width="23px" /></div>
						<div style="float:left;color:white;line-height: 50px;font-size:16px;font-weight: bold;margin-left:18px;">投放管理</div>
						<div style="float:right;padding-top:20px;margin-right:10px;"><img class="imageDiv" src="front/images/2.png" width="12px" /></div>
					</div>
				</dt>
				<dd style="padding:0px;margin:0px;">
					<ul style="padding:0px;margin:0px;">
						<li style="text-decoration: none;list-style-type:none;cursor: pointer;">
							<div style="width:100%;height:30px;line-height: 30px;text-align: center;"><a style="color:rgb(130,130,130);text-decoration: none;text-shadow: none;" data-href="deliveryAdd" data-title="添加投放" href="javascript:void(0)">添加投放</a></div></li>
				    </ul>
				</dd>
			</dl>
			<dl id="menu-article" style="pading:0px;margin:0px;">
				...
				<dd style="padding:0px;margin:0px;">
					<ul style="padding:0px;margin:0px;">
						<li style="text-decoration: none;list-style-type:none;cursor: pointer;"><div style="width:100%;height:30px;line-height: 30px;text-align: center;"><a style="text-decoration: none;color:rgb(130,130,130);text-shadow: none;" data-href="getOrderListNew" data-title="投放列表" href="javascript:void(0)">资源订单列表</a></div></li>
				    	<li style="text-decoration: none;list-style-type:none;cursor: pointer;">
							<div style="width:100%;height:30px;line-height: 30px;text-align: center;"><a style="text-decoration: none;color:rgb(130,130,130);text-shadow: none;" data-href="deliveryList" data-title="投放列表" href="javascript:void(0)">委托投放列表</a></div></li>
				    </ul>
				</dd>
			</dl>
			<dl id="menu-article" style="pading:0px;margin:0px;">
				...
				<dd style="padding:0px;margin:0px;">
					<ul style="padding:0px;margin:0px;">
						<li style="text-decoration: none;list-style-type:none;cursor: pointer;"><div style="width:100%;height:30px;line-height: 30px;text-align: center;"><a style="text-decoration: none;color:rgb(130,130,130);text-shadow: none;" data-href="front/newperson.jsp" data-title="修改密码" href="javascript:void(0)">修改密码</a></div></li>
				    </ul>
				</dd>
			</dl>
		</div>
...
<section class="Hui-article-box" style="position: absolute;right:0px;left:260px;top:58px;bottom: 0px;overflow: hidden;">
	<div id="iframe_box" class="Hui-article" style="position: absolute;right:0px;left:0px;top:0px;bottom: 0px;overflow: hidden;">
		<div class="show_iframe" style="position: absolute;right:0px;left:0px;top:0px;bottom: 0px;overflow: hidden;">
			...
			<iframe style="width:100%;height:100%;overflow: hidden;padding:0px;margin:0px;" scrolling="yes" frameborder="0" src="getOrderListNew"></iframe>
	</div>
</div>
</section>
</body>
